...
caffe.set_mode_cpu()
sys.path.append('../')
from cvtcaffe.onnx2caffe._transformers import ConvAddFuser, ConstantsToInitializers
from cvtcaffe.onnx2caffe._graph import Graph

import cvtcaffe.onnx2caffe._operators as cvt
import cvtcaffe.onnx2caffe._weightloader as wlr
from cvtcaffe.onnx2caffe._error_utils import ErrorHandling
...
if __name__ == "__main__":
    ...
    onnx_path = "../models/onnx/ep049_18_modify.onnx"
    prototxt_path = "./models/ep049_18_modify.prototxt"
    caffemodel_path = "./models/ep049_18_modify.caffemodel"
